...
router.post('/txt/qonly', async (request, response) => {
...
router.post('/txt/qna', async(request, response) => {
    let chat = request.body.chat;
...
router.post('/pdf/qonly', async (request, response) => {
    let chat = request.body.chat;
...
router.post('/pdf/qna', async (request, response) => {
    let chat = request.body.chat;
